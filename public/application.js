...
var find1Game = function find1Game(data) {
...
var specificGameSuccess = function specificGameSuccess(response) {
  console.log(response.game.length);
  // $('.sign-up').html(`response.length`)
};

var specificGameFail = function specificGameFail(response) {
...
var changePWfail = function changePWfail(resposne) {
...
module.exports = {
  ...
  specificGameSuccess: specificGameSuccess,
  specificGameFail: specificGameFail,
...
var consolidation = __webpack_require__(10);
...
var onGetGame = function onGetGame(event) {
  event.preventDefault();
  api.findGame().then(ui.getGameSuccess).catch();
};
...
var onspecificGame = function onspecificGame(event) {
  event.preventDefault();
  var data = getFormFields(event.target);
  console.log(data);
  api.find1Game(data).then(ui.specificGameSuccess).catch();
};

var onSignUpShow = function onSignUpShow(event) {
  event.preventDefault();
  ui.showSignInForm();
};

var onChangePWshow = function onChangePWshow(event) {
  event.preventDefault();
  ui.showChangePWForm();
};
...
module.exports = {
  ...
  onSignUpShow: onSignUpShow,
  onChangePWshow: onChangePWshow
};
...
var update = function update(index, values) {
  var data = {
    'game': {
      'cell': {
        'index': '' + index,
...
var updateWinLoose = function updateWinLoose() {
  var data = {
    'game': {
      'cell': {
        'index': undefined,
...
var winOrNot = function winOrNot() {
...
var inputImage = function inputImage(variable, square) {
  if (variable === 'X') {
